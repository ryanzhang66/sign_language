...
static void E53SC2IoInit(void)
{
    ...
    IoTGpioSetDir(WIFI_IOT_IO_NAME_GPIO_7, IOT_GPIO_DIR_OUT); // 设置GPIO_7为输出模式6
...
int E53SC2ReadData(E53SC2Data *ReadData)
{
    ...
    ReadData->Gyro[ACCEL_X_AXIS] = Gyro[ACCEL_X_AXIS];
    ReadData->Gyro[ACCEL_Y_AXIS] = Gyro[ACCEL_Y_AXIS];
    ReadData->Gyro[ACCEL_Z_AXIS] = Gyro[ACCEL_Z_AXIS];
